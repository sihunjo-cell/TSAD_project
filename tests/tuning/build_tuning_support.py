...
from tests.tuning.compare_execution_runtimes import compare_execution_runtime, load_runtime_references
from tests.tuning.select_ratio_tuning import _validate_full_prefix_trials
...
def build_tuning_support(selection, registry, budget, ledger, manifest_rows):
    ...
    runtime_references = load_runtime_references(
        tuning.REPOSITORY_ROOT / "experiments/tuning/logs/run_history/model_attempts", budget["budget_id"],
    )
